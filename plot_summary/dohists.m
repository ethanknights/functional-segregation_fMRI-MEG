...
for b = 1:length(list_bandNames); bandName = list_bandNames{b}; colourName = list_colourNames{b};
  eval(sprintf('tmpD(:,%d) = t.MEG_%s_noOrthog_lS;',b,bandName))
  eval(sprintf('histogram(tmpD(:,%d),''FaceColor'',''%s'',''FaceAlpha'',0.3,''EdgeColor'',''black'',''LineWidth'',2); hold on',b,colourName))
end
...
subplot(3,1,2);
for b = 1:length(list_bandNames); bandName = list_bandNames{b}; colourName = list_colourNames{b};
  eval(sprintf('tmpD(:,%d) = t.MEG_%s_orthog_lS;',b,bandName))
  eval(sprintf('histogram(tmpD(:,%d),''FaceColor'',''%s'',''FaceAlpha'',0.3,''EdgeColor'',''black'',''LineWidth'',2); hold on',b,colourName))
end
ylim(yLims); xlim(xLims); legend(list_bandNames,'Location','eastoutside'); box off; line([0,0],yLims,'color','black','LineStyle','--','LineWidth',1)
...
subplot(3,1,3);
for b = 1:length(list_bandNames); bandName = list_bandNames{b}; colourName = list_colourNames{b};
  eval(sprintf('tmpD(:,%d) = t.MEG_%s_orthog_partialCorr_lS;',b,bandName))
  eval(sprintf('histogram(tmpD(:,%d),''FaceColor'',''%s'',''FaceAlpha'',0.3,''EdgeColor'',''black'',''LineWidth'',2); hold on',b,colourName))
end
ylim(yLims); xlim(xLims); legend(list_bandNames,'Location','eastoutside'); box off; line([0,0],yLims,'color','black','LineStyle','--','LineWidth',1)
...
subplot(3,1,1);
for b = 1:length(list_bandNames); bandName = list_bandNames{b}; colourName = list_colourNames{b};
  eval(sprintf('tmpD(:,%d) = t.MEG_%s_noOrthog_lSReduced;',b,bandName))
  eval(sprintf('histogram(tmpD(:,%d),''FaceColor'',''%s'',''FaceAlpha'',0.3,''EdgeColor'',''black'',''LineWidth'',2); hold on',b,colourName))
end
ylim(yLims); xlim(xLims); legend(list_bandNames,'Location','eastoutside'); box off; line([0,0],yLims,'color','black','LineStyle','--','LineWidth',1)
title('MEG (no orthog)','Interpreter','none')
...
subplot(3,1,2);
for b = 1:length(list_bandNames); bandName = list_bandNames{b}; colourName = list_colourNames{b};
  eval(sprintf('tmpD(:,%d) = t.MEG_%s_orthog_lSReduced;',b,bandName))
  eval(sprintf('histogram(tmpD(:,%d),''FaceColor'',''%s'',''FaceAlpha'',0.3,''EdgeColor'',''black'',''LineWidth'',2); hold on',b,colourName))
end
ylim(yLims); xlim(xLims); legend(list_bandNames,'Location','eastoutside'); box off; line([0,0],yLims,'color','black','LineStyle','--','LineWidth',1)
title('MEG (orthog)','Interpreter','none')
...
subplot(3,1,3);
for b = 1:length(list_bandNames); bandName = list_bandNames{b}; colourName = list_colourNames{b};
  eval(sprintf('tmpD(:,%d) = t.MEG_%s_orthog_partialCorr_lSReduced;',b,bandName))
  eval(sprintf('histogram(tmpD(:,%d),''FaceColor'',''%s'',''FaceAlpha'',0.3,''EdgeColor'',''black'',''LineWidth'',2); hold on',b,colourName))
end
ylim(yLims); xlim(xLims); legend(list_bandNames,'Location','eastoutside'); box off; line([0,0],yLims,'color','black','LineStyle','--','LineWidth',1)
title('MEG (orthog + partialCorr)','Interpreter','none')
...
ylim(yLims); xlim(xLims); box off; line([0,0],yLims,'color','black','LineStyle','--','LineWidth',1)
%fMRI - PartialCorr
t = readtable('/imaging/camcan/sandbox/ek03/projects/functional-segregation_fMRI-MEG/fMRI_Schaefer/data/004_computeSyS/partialCorr_schaefer_associationOnly/SySTable.csv');
...
subplot(3,1,1);
for b = 1:length(list_bandNames); bandName = list_bandNames{b}; colourName = list_colourNames{b};
  eval(sprintf('tmpD(:,%d) = t.%s;',b,bandName))
  eval(sprintf('histogram(tmpD(:,%d),''FaceColor'',''%s'',''FaceAlpha'',0.3,''EdgeColor'',''black'',''LineWidth'',2); hold on',b,colourName))
end
ylim(yLims); xlim(xLims); legend(list_bandNames,'Location','eastoutside'); box off; line([0,0],yLims,'color','black','LineStyle','--','LineWidth',1)
title('MEG (no orthog)','Interpreter','none')
