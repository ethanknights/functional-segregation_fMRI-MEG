...
xLims = [-1.5,1];
%noOrthog
t = readtable('/imaging/camcan/sandbox/ek03/projects/functional-segregation_fMRI-MEG/MEG_cc280/data/computeSyS/ROIs-Schaefer_100parcels_7networks_version-noOrthogDespikeEnvel/SySTable_allBands_doOrthog-0.csv');
subplot(3,1,1);
for b = 1:length(list_bandNames); bandName = list_bandNames{b}; colourName = list_colourNames{b};
...
title('MEG (no orthog)','Interpreter','none')
%orthog
t = readtable('/imaging/camcan/sandbox/ek03/projects/functional-segregation_fMRI-MEG/MEG_cc280/data/computeSyS/ROIs-Schaefer_100parcels_7networks_version-orthogDespikeEnvel/SySTable_allBands_doOrthog-1.csv');
subplot(3,1,2);
for b = 1:length(list_bandNames); bandName = list_bandNames{b}; colourName = list_colourNames{b};
  eval(sprintf('tmp_cc280D(:,%d) = t.%s;',b,bandName))
  eval(sprintf('histogram(tmp_cc280D(:,%d),''FaceColor'',''%s'',''FaceAlpha'',0.3,''EdgeColor'',''black'',''LineWidth'',2); hold on',b,colourName))
...
title('MEG (orthog)','Interpreter','none')
%orthog + partialCorr
t = readtable('/imaging/camcan/sandbox/ek03/projects/functional-segregation_fMRI-MEG/MEG_cc280/data/computeSyS/ROIs-Schaefer_100parcels_7networks_version-orthogDespikeEnvelPartialCorr/SySTable_allBands_doOrthog-1.csv');
subplot(3,1,3);
for b = 1:length(list_bandNames); bandName = list_bandNames{b}; colourName = list_colourNames{b};
  eval(sprintf('tmp_cc280D(:,%d) = t.%s;',b,bandName))
  eval(sprintf('histogram(tmp_cc280D(:,%d),''FaceColor'',''%s'',''FaceAlpha'',0.3,''EdgeColor'',''black'',''LineWidth'',2); hold on',b,colourName))
...
xLims = [-0.05,0.1];
%noOrthog
t = readtable('/imaging/camcan/sandbox/ek03/projects/functional-segregation_fMRI-MEG/MEG_cc280/data/computeSyS/ROIs-Schaefer_100parcels_7networks_version-noOrthogDespikeEnvel/SySTable_noNormalisation_allBands_doOrthog-0.csv');
subplot(3,1,1);
for b = 1:length(list_bandNames); bandName = list_bandNames{b}; colourName = list_colourNames{b};
  eval(sprintf('tmp_cc280D(:,%d) = t.%s;',b,bandName))
  eval(sprintf('histogram(tmp_cc280D(:,%d),''FaceColor'',''%s'',''FaceAlpha'',0.3,''EdgeColor'',''black'',''LineWidth'',2); hold on',b,colourName))
...
title('MEG (no orthog)','Interpreter','none')
%orthog
t = readtable('/imaging/camcan/sandbox/ek03/projects/functional-segregation_fMRI-MEG/MEG_cc280/data/computeSyS/ROIs-Schaefer_100parcels_7networks_version-orthogDespikeEnvel/SySTable_noNormalisation_allBands_doOrthog-1.csv');
subplot(3,1,2);
for b = 1:length(list_bandNames); bandName = list_bandNames{b}; colourName = list_colourNames{b};
  eval(sprintf('tmp_cc280D(:,%d) = t.%s;',b,bandName))
  eval(sprintf('histogram(tmp_cc280D(:,%d),''FaceColor'',''%s'',''FaceAlpha'',0.3,''EdgeColor'',''black'',''LineWidth'',2); hold on',b,colourName))
...
title('MEG (orthog)','Interpreter','none')
%orthog + partialCorr
t = readtable('/imaging/camcan/sandbox/ek03/projects/functional-segregation_fMRI-MEG/MEG_cc280/data/computeSyS/ROIs-Schaefer_100parcels_7networks_version-orthogDespikeEnvelPartialCorr/SySTable_noNormalisation_allBands_doOrthog-1.csv');
subplot(3,1,3);
for b = 1:length(list_bandNames); bandName = list_bandNames{b}; colourName = list_colourNames{b};
  eval(sprintf('tmp_cc280D(:,%d) = t.%s;',b,bandName))
  eval(sprintf('histogram(tmp_cc280D(:,%d),''FaceColor'',''%s'',''FaceAlpha'',0.3,''EdgeColor'',''black'',''LineWidth'',2); hold on',b,colourName))
