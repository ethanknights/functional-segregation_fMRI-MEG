...
S.M = RP;
S.C = [WMCSF]; %S.C = [WMCSF,G]; %CHANGED THIS - REMOVED GLOBAL CONFOUND
...
[Zmat, Bmat, pZmat, pBmat, aY, X0r] = rsfMRI_GLM_p36_noGlobalSignal(S); %additional covariates: derivates of GS, WM, CSF 
