...
function [W,B,S] = computeSyS_associationOnly_craddock(outDir,corrM)
...
%% drop networks
listNetworkStrToDrop = {'noNetwork','SMN','auditory','brainstem','basal ganglia','cerebellum','thalamus','visual','temporal'};
